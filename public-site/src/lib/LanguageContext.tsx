...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    enq_field_message: "Remarks *",
    enq_placeholder_msg: "Enter any remarks, custom instructions, or delivery specifications here...",
  ...
  hi: {
    ...
    enq_field_quantity: "अनुमानित मात्रा *",
    enq_field_market: "आपका बाजार / देश",
    enq_field_station: "स्टेशन (राज्य और क्षेत्र) *",
    enq_placeholder_station: "उदा. इंदौर, मध्य प्रदेश",
    enq_field_message: "टिप्पणी *",
    enq_placeholder_msg: "यहाँ कोई टिप्पणी, कस्टम निर्देश, या डिलीवरी विवरण दर्ज करें...",
