...
export default function ExportPage() {
  return <div className="min-h-screen bg-[#161612] text-[#F4EFE6]"><main>
    ...
    <section className="bg-[#1E211E] px-5 py-20 sm:px-8 lg:px-12 lg:py-24"><div className="mx-auto grid max-w-[1500px] gap-10 lg:grid-cols-[.8fr_1.2fr]"><h2 className="font-display text-4xl font-black uppercase leading-[.86] tracking-[-.07em] sm:text-6xl">Sourcing first.<br />Shipping next.</h2><div className="border-t border-[#F4EFE6]/15 pt-5 text-sm leading-relaxed text-[#F4EFE6]/65"><p>International orders benefit from a clear product brief, realistic quantity planning and documented quality expectations. Specific export claims, certifications and logistics arrangements should be confirmed directly for each requirement.</p><p className="mt-5 text-[#F4EFE6]/85">Tell us the product, market, quantity and delivery context to start the right conversation.</p></div></div></section>
